...
public class GameWonState extends GameState {
	...
	public void render() {
		...
		sb.begin();
			...
			font.draw(sb, "Lives left: " + hud.getLives(), Game.V_WIDTH/2-80, Game.V_HEIGHT/2-15);
			font.draw(sb, "Time: " + (int) hud.getTime(), Game.V_WIDTH/2-80, Game.V_HEIGHT/2-30);
			font.draw(sb, "Grade: " + hud.getScore(), Game.V_WIDTH/2-80, Game.V_HEIGHT/2-45);
			font.draw(sb, "Congratulations, you won!", Game.V_WIDTH/2-80, Game.V_HEIGHT/2);
